...
- 십자리: `biggest_palindrome(1)`를 실행하면 `r biggest_palindrome(1)`.
- 백자리: `biggest_palindrome(2)`를 실행하면 `r biggest_palindrome(2)`.
- 천자리: `biggest_palindrome(3)`를 실행하면 `r biggest_palindrome(3)`.
- 만자리: `biggest_palindrome(4)`를 실행하면 `r biggest_palindrome(4)`.
