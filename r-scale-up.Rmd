...
cl <- makeCluster(no_cores, type="PSOCK") # FORK
...
``` {r eval=FALSE}
                       test replications elapsed relative
1     square_loop_noinit(n)          100  177.15    17715
2   square_loop_withinit(n)          100    2.94      294
5 square_parallel_sapply(n)          100    3.62      362
3          square_sapply(n)          100    2.75      275
4             square_vec(n)          100    0.01        1
```
