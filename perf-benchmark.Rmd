...
``` {r benchmark-sys-time, message=FALSE, warning=FALSE}
start_time <- Sys.time()
...
``` {r benchmark-system-time, message=FALSE, warning=FALSE}
...
``` {r benchmark-r-sample-code, message=FALSE, warning=FALSE}
#-------------------------------------------------------------------------
# 1. 순수한 R 코드
#-------------------------------------------------------------------------
...
``` {r benchmark-tictoc-benchamrk, message=FALSE, warning=FALSE}
...
``` {r benchmark-rbenchamrk, message=FALSE, warning=FALSE}
...
``` {r benchmark-microbenchamrk, message=FALSE, warning=FALSE}
...
``` {r benchmark-rcpp, message=FALSE, warning=FALSE}
library(Rcpp)
