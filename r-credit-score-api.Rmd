...
<img src="fig/predictive-model-api.png" alt="예측모형 배관공(plumber) 공동작업" width="77%" />
...
<img src="fig/credit-model-api-script.png" alt="예측모형 API 스크립트" width="77%" />
