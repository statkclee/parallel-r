...
``` {r titanic-predictive-model, eval=FALSE}
# 0. 환경설정 -------------------
library(tidyverse)
...
``` {r restful-api-servcie-healthcheck, eval=FALSE}
library(plumber)
...
``` {r restful-api-servcie-homepage, eval=FALSE}
...
``` {r restful-api-servcies-endpoint, eval=FALSE}
